...
<body>
    <!-- ============================================================
    🧩  README.md  (copy this entire block into your README.md)
    ============================================================ -->
    <div align="center">
    ...
    <table>
        <tr>
            <td width="70%">
                ...
                💡 **Developer passionate about building real-world solutions with modern tech** <br>
                🤖 Exploring **AI, automation, and system design** <br>
                🌐 **Full-stack builder** &amp; open-source enthusiast <br>
                🔐 Interested in **cybersecurity &amp; performance systems** <br>
    ...
    <!-- ============================================================
    🆕  CUSTOM CONTRIBUTION CALENDAR (hexagonal / honeycomb style)
    ============================================================ -->
    ## 📅 Contribution Calendar (HexGrid)

    <p align="center">
        <!--
        Save the SVG from the first file as:
        ./assets/contributions-calendar.svg
